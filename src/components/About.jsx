...
const About = () => {
  ...
  return (
    <div className="w-full  py-16 px-4 bg-[#f7f7f7]">
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-2 gap-6 items-center p-6 md:p-12 h-full">
        {/* Image Section */}
        <div className="flex items-center justify-center h-full ">
          <img
            className="w-full h-full object-cover rounded-lg shadow-lg rounded-tl-[100px]"
        ...
        {/* Text Section */}
        <div className="flex flex-col justify-center h-full bg-amber-600 rounded-lg rounded-br-[100px]  shadow-lg p-6 md:p-8">
          ...
          <button
            ...
            className="self-start md:self-center bg-white text-sm border  border-black text-black font-medium  px-6 py-3  hover:bg-amber-600 hover:text-white transition duration-300 active:scale-95"
          >
            Learn More...
          </button>
        </div>
